...
if __name__ == "__main__":
    ...
    parser.add_argument('--ckpt_path', type=str, default='../weights/mnist_svhn_disc',
...
# path parameters
MODEL_NAME = 'mnist_svhn_disc-run_id%d-priv%02ddim-label_frac%s-sup_frac%s-lamb_text1_%s-lamb_text2_%s-beta1%s-beta2%s-seed%s-bs%s-wseed%s' % (
