...
from dataset_dsprite_weak import Position
...
for e in range(args.ckpt_epochs, args.epochs):
    ...
    train_elbo = train(train_data, encA, decA, encB, decB,
                             optimizer)
...
if args.ckpt_epochs == args.epochs:
    import  numpy as np
    fixed_idxs = np.linspace(0, 245759, 10)
    fixed_idxs = [int(elt) for elt in fixed_idxs]
    util.evaluation.save_traverse_both(args.epochs, test_data, encA, decA, encB, decB,  CUDA, output_dir_trvsl=MODEL_NAME, fixed_idxs=fixed_idxs)
